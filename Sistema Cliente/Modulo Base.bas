...
Global hora_inicial As Date
Global hora_atual As Date
Global qtde As Date
Global tempo_user As Date
Global restante As Date
...
Function Calcula_Maq(vIP)
    ...
    If vIP = "192.168.0.1" Or "10.0.0.1" Or "127.0.0.1" Then
        Calcula_Maq = "01"
    
    ElseIf vIP = "192.168.0.2" Or "10.0.0.2" Or "127.0.0.2" Then
        Calcula_Maq = "02"

    ElseIf vIP = "192.168.0.3" Or "10.0.0.3" Or "127.0.0.3" Then
        Calcula_Maq = "03"

    ElseIf vIP = "192.168.0.4" Or "10.0.0.4" Or "127.0.0.4" Then
        Calcula_Maq = "04"

    ElseIf vIP = "192.168.0.5" Or "10.0.0.5" Or "127.0.0.5" Then
        Calcula_Maq = "05"

    ElseIf vIP = "192.168.0.6" Or "10.0.0.6" Or "127.0.0.6" Then
        Calcula_Maq = "06"

    ElseIf vIP = "192.168.0.7" Or "10.0.0.7" Or "127.0.0.7" Then
        Calcula_Maq = "07"

    ElseIf vIP = "192.168.0.8" Or "10.0.0.8" Or "127.0.0.8" Then
        Calcula_Maq = "08"

    ElseIf vIP = "192.168.0.9" Or "10.0.0.9" Or "127.0.0.9" Then
        Calcula_Maq = "09"

    ElseIf vIP = "192.168.0.10" Or "10.0.0.10" Or "127.0.0.10" Then
        Calcula_Maq = "10"
